...
def fill_between_3d(ax, x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4, mode=1, c='steelblue', alpha=0.6):
    """
    ...
    if mode == 1:
        ...
        for i in range(len(x1) - 1):
            ...
            verts = [(x1[i], y1[i], z1[i]), (x1[i + 1], y1[i + 1], z1[i + 1])] + \
                    [(x2[i + 1], y2[i + 1], z2[i + 1]), (x2[i + 1], y2[i + 1], z2[i + 1])] + \
                    [(x3[i + 1], y3[i + 1], z3[i + 1]), (x3[i], y3[i], z3[i])] + \
                    [(x4[i], y4[i], z4[i]), (x4[i], y4[i], z4[i])]
